...
- ✓ **AUTH-01**: STAFF/ADMIN sign in via Clerk username+password, no self-signup — Phase 1 ✅
- ✓ **AUTH-02**: Role stored in Clerk `public_metadata.role` ("ADMIN" or "STAFF") — Phase 1 ✅
- ✓ **SYNC-01**: Clerk webhooks handler at `/api/auth/webhook` (InstantDB writes stubbed for Phase 4) — Phase 1 ✅
