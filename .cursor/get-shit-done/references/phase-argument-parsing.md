...
```bash
PHASE_INFO=$(node "/Users/nhannguyenthanh/Developer/lpoint/.cursor/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/nhannguyenthanh/Developer/lpoint/.cursor/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/Users/nhannguyenthanh/Developer/lpoint/.cursor/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
