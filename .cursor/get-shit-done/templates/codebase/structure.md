...
- Usage: Reference from command with `@/Users/nhannguyenthanh/Developer/lpoint/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/nhannguyenthanh/Developer/lpoint/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/nhannguyenthanh/Developer/lpoint/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
