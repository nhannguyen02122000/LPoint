...
- **Global scope**: `/Users/nhannguyenthanh/Developer/lpoint/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/nhannguyenthanh/Developer/lpoint/.claude/notes/`)
...
2. Glob `/Users/nhannguyenthanh/Developer/lpoint/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/nhannguyenthanh/Developer/lpoint/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/nhannguyenthanh/Developer/lpoint/.claude/notes/` — works in any directory
